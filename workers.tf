...
resource "aws_launch_configuration" "workers" {
  ...
  iam_instance_profile        = "${element(coalescelist(aws_iam_instance_profile.workers.*.name, data.aws_iam_instance_profile.custom_worker_group_iam_instance_profile.*.name), count.index)}"
